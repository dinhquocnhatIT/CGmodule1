...
// (income > 10000000 && income <= 18000000) ?  console.log('tien thue phai dong la:' + ((income * 15)/100) + 'VND') : (income > 18000000 && income <= 32000000) ? console.log('tien thue phai dong la:' + ((income * 20)/100) + 'VND') :
